                ...
                <section class="table">
                    <div class="wrapper__table">
                        <div class="table__header">
                            <h1 class="title">Tabel Data Siswa</h1>
                        </div>
                        <div class="table__body">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td>Muhammad Zidan Hikayatulloh</td>
                                        <td>XI</td>
                                        <td>RPL</td>
                                        <td>A</td>
                                    </tr>
                    ...
                    <div class="wrapper__table">
                        <div class="table__header">
                            <h1 class="title">Tabel Data Guru</h1>
                        </div>
                        <div class="table__body">
                            <table>
                                <thead>
